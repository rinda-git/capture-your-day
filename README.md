...
# サービスの差別化
  ...
  AIが英文を添削するだけでなく、より自然に伝えるための表現を抽出します。添削結果を表示するだけでなく、学習すべきポイント
  を把握できます。

  ### 2. 類似表現から表現の幅を広げられる

  ピックアップされた表現に関連する類似表現も提案します。1つの添削から複数の言い回しを学び、表現の選択肢を増やせます。

  ### 3. 学んだ表現を蓄積して復習できる

  覚えたい表現を保存し、アプリ内やLINE通知から繰り返し復習できます。添削を一度きりで終わらせず、自分だけの英語表現として
  蓄積できます。
